...
// React import is automatically handled by Next.js
...
export default function AdminSignUpPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <div className="hidden lg:flex lg:w-1/2 bg-secondary items-center justify-center">
        <div className="p-12">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between pt-2">
                  <Link href="/" className="text-muted-foreground text-sm hover:underline">
                    Back
                  </Link>                  <Button className="bg-secondary text-secondary-foreground hover:bg-secondary/90" type="submit" disabled={isLoading}>
